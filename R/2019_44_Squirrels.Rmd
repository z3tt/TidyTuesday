...
ggplot(df_squirrels) + 
  geom_hex(aes(long, lat, color = ..count..)) + 
  coord_fixed() + 
  scale_x_continuous(labels = scales::unit_format(accuracy = 0.01, sep = "", unit = "°W"), position = "top") + 
  scale_y_continuous(labels = scales::unit_format(accuracy = 0.01, sep = "", unit = "°N")) +
  rcartocolor::scale_color_carto_c(palette = "Sunset", name = "Number of Squirrels Counted\nin NYC's Central Park", 
