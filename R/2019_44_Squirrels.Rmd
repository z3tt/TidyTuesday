...
theme_update(rect = element_rect(fill = "#f2eadf"),
             ...
             panel.border = element_rect(color = "grey55", size = 2))
```
...
map_density <- 
  ggplot(df_squirrels) +
    ...
    #scico::scale_color_scico("lajolla", direction = -1)
    ...
    annotate("text", x = -73.9625, y = 40.786, 
             ...
             family = "Alice", color = "#2e85b0", size = 4.5, fontface = "bold") +
...
map_fur <- 
  ...
  ggplot() +
    ...
    geom_point(aes(long, lat, fill = primary_fur_color, alpha = primary_fur_color),
               shape = 21, color = "grey20", size = 1.2, 
               stroke = 0.3) +
    scale_x_continuous(limits = c(-73.982, -73.9495)) +
    scale_y_continuous(limits = c(40.7648, 40.8)) +
...
ggsave(here::here("plots", "2019_44", "2019_44_squirrels.pdf"), width = 13, height = 12.8, device = cairo_pdf)
```
