...
cartos <- c(carto_cvd, carto_cancer, carto_diabetes, carto_hiv, carto_malaria, carto_conflict)
saveRDS(cartos, here::here("plots", "2018_03", "cartos.Rds"))
```
...
ggsave(here::here("plots", "2018_03", "2018_03_Global_Mortality.pdf"), width = 18, height = 12.5, device = cairo_pdf)
```
