...
df_school_index %>% 
  ...
  scale_color_viridis_c(option = "magma", guide = F, begin = 0.2) +
  scale_y_continuous(limits = c(0, 100)) +
  scale_x_continuous(limits = c(0, 1)) +
  labs(x = "Simpson Diversity Index", y = "Proporiton of White Students",
       title = "Correlation between the Simpsons diversity index and the proportion of white students in the school year 2016–2017",
       caption ="\nVisualization by Cédric Scherer  |  Data: NCES") +
