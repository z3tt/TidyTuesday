...
map <- 
  ...
  ggplot() +
    ...
    labs(x = NULL, y = NULL,
         ...
         subtitle = "<br>Bivariate map showing the combination of racial diversity measured as <b style='color:#C85A5A'>Simpson index</b>, a quantitative diversity measure,<br>and the <b style='color:#64ACBE'>proportion of students with white ethnicity</b> during the <b>school year 2016–2017</b>.")
...
ggsave(here::here("plots", "2019_39", "2019_39_SchoolDiversity.pdf"), 
       width = 14, height = 17, device = cairo_pdf)
```

## Pointdensity plot

```{r corr-plot, fig.width = 16, fig.height = 18}
df_school_index %>% 
  ...
  labs(x = "Simpson Diversity Index", y = "Proportion of White Students",
       ...
       subtitle = "Pointdensity scatterplot of the  <b style='color:#d3d3d3'>Simpson diversity index</b> and the <b style='color:#d3d3d3'>proportion of white students</b><br>in US schools during the school year 2016–2017<br>",
       caption ="\nVisualization by Cédric Scherer  |  Data: NCES") +
...
ggsave(here::here("plots", "2019_39", "2019_39_SchoolDiversity_correlation.pdf"),
       width = 11, height = 12, device = cairo_pdf)
```
