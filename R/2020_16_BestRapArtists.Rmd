...
bars <- 
  ...
  ggplot(aes(artists, -points)) +
    geom_col(aes(fill = ID),
             ...
             size = .5,
             width = 1.02) +
    geom_curve(aes(x = 52.2, xend = 48, 
                   y = -148, yend = -166),
               curvature = -.4) +
    annotate("text", x = 48, y = -185, 
...
dots <-
  ...
  ggplot(aes(artists, era_num, group = artists)) +
    geom_point(aes(artists, 1), color = "grey70", size = 2) +
    geom_point(aes(artists, 2), color = "grey70", size = 2) +
    geom_point(aes(artists, 3), color = "grey70", size = 2) +
    geom_point(aes(artists, 4), color = "grey70", size = 2) +
    ...
    geom_point(aes(fill = best, size = n_songs), 
               ...
               color = "black", 
               stroke = 1.2) +
    geom_curve(aes(x = 48, xend = 51, 
                   y = 6.1, yend = 4.3),
               curvature = .4) +
    annotate("text", x = 46.1, y = 6.1, 
