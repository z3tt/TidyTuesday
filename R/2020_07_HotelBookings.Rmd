...
df_hotels %>% 
  ...
  mutate(
    ...
    ## -> uncomment for grey text in the two lower rows and change scale_color below
    text = case_when(
  ...
  ggplot(aes(xmax = 3, xmin = 2.4, 
    ...
    scale_color_manual(values = col8, guide = F) +  ## -> set to "col5" for grey text in the two lower rows
...
ggsave(here::here("plots", "2020_07", "2020_07_HotelBookings.pdf"), #"plots", 
