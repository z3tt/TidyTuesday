---
title: "TidyTuesday 2019/23 - Ramen Ratings by TheRamenRater.com"
...
```{r data}
df_ramen <- readr::read_csv("https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2019/2019-06-04/ramen_ratings.csv") %>% 
  unique()
```
...
ggsave("./plots/2019_22/2019_22_Wines.pdf", width = 14, height = 5.3, device = cairo_pdf)
```
