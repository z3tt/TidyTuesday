...
df_coffee_p <-
  ...
  summarize(total_cup_points = mean(total_cup_points)) %>% 
  ...
  mutate(#
    ...
    country_of_origin = case_when(
      ...
      country_of_origin == "United States (Hawaii)" ~ "Hawaii",
