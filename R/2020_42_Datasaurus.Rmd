---
title: "TidyTuesday 2020/42 - The Datasaurus Dzoen by Alberto Cairo"
...
sauR <- 
  ggplot(data = df_saurus_lab,
    ...
    labs(x = NULL, y = NULL, 
         ...
         caption = "Idea by Francis Anscombe, Alberto Cairo, Justin Matejka & George Fitzmaurice\nVisualization by Cédric Scherer based on code by Tom Westlake") + #ggsave("test2.jpeg", width = 20, height = 24, type = "cairo")
...
anim <- 
  animate(sauR, nframes = 100, fps = 5, detail = 5, 
          ...
          #renderer = file_renderer(dir = here::here("plots", "2020_42"), 
