---
title: "TidyTuesday 2022/12 - Baby Names by SSA"
...
df_names_div_std <- 
  ...
  mutate(
    ...
    sex = ifelse(sex == "F", "<span style='color:#747E38;'>Female Babies</span>", 
                             "<span style='color:#B88E34;'>Male Babies</span>")
  )
...
annotation <-
  ...
  mutate(sex = ifelse(sex == "F", "<span style='color:#747E38;'>Female Babies</span>", 
                                  "<span style='color:#B88E34;'>Male Babies</span>")) %>% 
...
plot_names_div_blank <-
  ...
  scico::scale_color_scico(
    ...
    limits = range(df_names_div_std$shannon_std), guide = "none"
  ) +
  ...
  labs(
    ...
    subtitle = "Even though <b style='font-family:Sentient-Medium;color:#001959'>female baby names are overall more diverse</b>, the most diverse names by first letter are male ones starting with *J*. Afterwards follow female names, starting with *M*, *A*, *L*, and *J*. Names with *J* as the first letter is also the most diverse across sexes.<br>The diversity of names increased steadily across and within sexes. However, some letter–sex combinations exhibit different trends: <span style='color:#DC4BC1;'>since 1990, of all female babies born in the U.S. <b style='font-family:Sentient-Medium;color:#DC4BC1;'>83% where named *Olivia*</b> in case the name starts with an *O*</span>. Overall, names with *X* are scarce with *Xenia* and *Xavier* being by far the most common.",
    caption = "Graphic: Cédric Scherer  •  Data: U.S. Social Security Administration (SSA)\nDiversity of baby names in the U.S. from 1880 to 2017 was estimated as Shannon diversity per sex and first letter and standardized across both sexes afterwards."
  )

ggsave(here::here("plots", "2022_12", "2022_12_Babynames_Diversity_blank.pdf"), 
...
ggsave(here::here("plots", "2022_12", "2022_12_Babynames_Diversity_olivia.pdf"), 
       width = 31, height = 18, device = cairo_pdf)
...
ggsave(here::here("plots", "2022_12", "2022_12_Babynames_Diversity_labs.pdf"), 
       width = 31, height = 18, device = cairo_pdf)
...
ggsave(here::here("plots", "2022_12", "2022_12_Babynames_Diversity_period.pdf"), 
       width = 31, height = 18, device = cairo_pdf)
...
ggsave(here::here("plots", "2022_12", "2022_12_Babynames_Diversity_all.pdf"), 
       width = 31, height = 18, device = cairo_pdf)
```
...
ggsave(here::here("plots", "2022_12", "long_version", "2022_12_Babynames_Diversity_blank_long.pdf"), 
...
ggsave(here::here("plots", "2022_12", "long_version", "2022_12_Babynames_Diversity_olivia_long.pdf"), 
       width = 18, height = 31, device = cairo_pdf)
...
ggsave(here::here("plots", "2022_12", "long_version", "2022_12_Babynames_Diversity_labs_long.pdf"), 
       width = 18, height = 31, device = cairo_pdf)
...
ggsave(here::here("plots", "2022_12", "long_version", "2022_12_Babynames_Diversity_period_long.pdf"), 
       width = 18, height = 31, device = cairo_pdf)
...
ggsave(here::here("plots", "2022_12", "long_version", "2022_12_Babynames_Diversity_all_long.pdf"), 
       width = 18, height = 31, device = cairo_pdf)
```
