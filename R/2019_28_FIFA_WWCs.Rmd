...
df_squads <- readr::read_csv("https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2019/2019-07-09/squads.csv")
```
...
img_usa <- png::readPNG("./img/flag_usa.png") 
usa <- grid::rasterGrob(img_usa, interpolate = T)
img_ger <- png::readPNG("./img/flag_ger.png") 
ger <- grid::rasterGrob(img_ger, interpolate = T)
img_jpn <- png::readPNG("./img/flag_jpn.png") 
jpn <- grid::rasterGrob(img_jpn, interpolate = T)
img_nor <- png::readPNG("./img/flag_nor.png") 
nor <- grid::rasterGrob(img_nor, interpolate = T)
img_ned <- png::readPNG("./img/flag_ned.png") 
...
p_steps <- 
  ...
  ggplot(aes(round_id, points_sum)) +
    ...
    geom_step(aes(group = team), colour = "grey20", alpha = 0.2, size = 0.4) +
...
p_wins <- 
  ...
  ggplot(aes(round_id, wins)) +
    ...
    labs(x = NULL, y = "Matches won",
         caption = "\nVisualization by @CedScherer  |  Data: Wikipedia")
```
...
ggsave("./plots/2019_28/2019_28_FIFA_WWCs.pdf", width = 14, height = 5.7, device = cairo_pdf)
```
