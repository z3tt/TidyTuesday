...
ranks <- 
  ggplot(df_simpsons_lumped, 
    ...
    annotate("label", x = 10, y = 55, 
             ...
             label = 'Ranking of guest star appearances per\nseason in the TV series "The Simpsons".\n\nThe six top guests are colored\n and visualised as there common character.\nAll others are ranked anonymously\nshowing the number of guests per season.\nIn case of a tie guest stars\nare sorted by total appearances.') +
...
caption <- 
  ...
  labs(x = NULL, y = NULL,
       caption = "Visualization by @CedScherer  |  Source: Wikipedia  |  Image  Copyright: Matt Groening & 20th Century Fox                                                   ") +
...
ggsave("./plots/2019_35/2019_35_SimpsonsGuests.pdf", width = 16, height = 24, device = cairo_pdf)
```
