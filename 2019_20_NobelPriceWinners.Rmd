---
title: "TidyTuesday 2019/20 - Nobel Prize Winners by "
...
#df_nobel_all_pubs <- readr::read_csv("https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2019/2019-05-14/nobel_winner_all_pubs.csv")
```
...
df_nobel %>% 
  ...
  ggplot(aes(decade, category, color = prop, label = label)) +
    ...
    facet_grid(. ~ gender) +
    scale_color_scico(palette = "berlin", name = NULL, na.value = "grey25",
    ...
    labs(x = NULL, y = NULL,
         caption = '\nVisualization by @CedScherer  |  Data: Harvard Dataverse, Li et al. 2018, doi: 10.7910/DVN/6NJ5RN')
...
## full panel
title + tile_gender + plot_layout

ggsave("./plots/2019_20/2019_20_nobel_tile_gender.pdf", width = 14, height = 5, device = cairo_pdf)
```
