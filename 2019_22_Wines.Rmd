...
title <- ggplot(data.frame(x = 1:2, y = 1:10)) +
  labs(x = NULL, y = NULL,
       ...
       subtitle = "Highest country-level ratings and their 5 highest rated varieties listed on Vivino for countries with \u2265 100 wines (based on reviews with 80 points or more).\n") +
