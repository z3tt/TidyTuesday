---
title: "TidyTuesday 2019/21 - Global Plastic Waste by Our World In Data"
  ...
  ggplot() +
    ...
    scale_fill_scico_d(palette = "bilbao", na.value = "grey30", 
                       ...
                       labels = c("0%-10%", "10%-20%", "20%-30%", 
                                  ...
                                  "60%-70%", "70%-80%", "80%-90%", 
                                  "missing data")) +
    theme(legend.position = c(0.55, -0.24),
...
```{r full-panel}
title + bar_waste + map_waste_prop + bar_mismanaged +
  plot_layout(widths = c(0, 0.27, 1, 0.25), nrow = 1)
