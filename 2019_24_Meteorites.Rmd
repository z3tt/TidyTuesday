...
map_pixel <- ggplot(map_data("world"), aes(round(long, 0), round(lat, 0))) +
  geom_polygon(aes(group = group), fill = "#001810", color = "#004e00") + ##004e00 #2e482e
  ...
  geom_rect(data = df_meteor_heavy, 
            ...
            color = "grey55", fill = "#001810", alpha = 0.7, size = 0.1) +
  ...
  theme(plot.caption = element_text(family = "Orbitron",  
        ...
        axis.ticks = element_line(color = "transparent")) +
  labs(x = NULL, y = NULL, 
       caption = "Provided by @CedScherer & National Aeronautics and Space Administration (NASA)  ")
```
...
ggsave("./plots/2019_24/2019_24_Meteorites.pdf", width = 14, height = 5.3, device = cairo_pdf)
```
